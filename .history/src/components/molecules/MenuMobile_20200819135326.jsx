...
const MenuMobile = () => {
  return (
    <nav className="mb-4 bg-purple-600 fixed inset-0 opacity-75 p-4">
      <ul className="flex-1 content-center">
        <li> <NavLink className="text-lg font-semibold text-black-800 
