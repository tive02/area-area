...
const Header = () => (
  ...
  <header>
    <div className="flex items-center justify-between flex-wrap bg-purple-700  p-6" >
      ...
      <div className="flex-col flex-grow pb-4 lg:pb-0 hidden lg:flex lg:justify-start lg:flex-row" >
        <div>
          <button
            class="mr-16 bg-blue-500 hover:bg-blue-400 text-white font-bold py-2 px-4 border-b-4 
