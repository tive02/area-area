...
const Banner = ({ title, subtitle, img, Description, height }) => (
  ...
  >
    ...
    <div className="content-center w-full lg:w-1/2 pt-16 pb-8 lg:pt-20">
      <h1 className="text-center text-5xl font-serif font-back text-purple-600 pt-6 pb-0  md:text-6xl ">
        {title}
      </h1>
      <h2 className="text-center text-lg font-serif font-thin text-green-400 mr-2 md:grid md:grid-row">
        {subtitle}
      </h2>
    </div >
  </div>
