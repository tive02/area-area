...
const Banner = ({ title, subtitle, img, Description }) => (
  <div
    className={classnames(`flex md:p-8 border-2 divide-x divide-black
    `)}
  >
    <div className="bg-red-500  lg:w-1/2 pt-16 pb-8 lg:pt-20">
    ...
    <div className="bg-blue-500 hidden lg:flex lg:w-1/2 lg:pt-20 lg:justify-center ">
