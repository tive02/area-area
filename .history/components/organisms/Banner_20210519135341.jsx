...
const Banner = ({ title, subtitle, img, altImg, description }) => (
  ...
  >
    <div className=" absolute z-10 top-0 w-full h-full bg-center bg-cover overflow-hidden object-contain bg-black">
      <div clasName="-z-10 w-full h-full absolute opacity-75">
        <Image
          alt={altImg}
          src={img}
          layout="responsive"
