  ...
  return (
    <>
      ...
      >
        ...
        <div
          className=" border-b-2 border-white  lg:border-r-4  lg:p-4 lg:border-b-0 
        flex flex-row justify-around text-white "
        >
          <div className="w-full flex flex-col space-y-4">
            <a className="opacity-60 ">Acerca de Nosotros</a>
            <a className="opacity-60 ">Nuestros Servicios</a>
            <a className="opacity-60 ">Contacto</a>
          </div>
          <div className="w-full flex flex-col space-y-4">
            <a className="opacity-60">Testimonios</a>
            <a className="opacity-60">Política de privacidad</a>
            <a className="opacity-60">Términos de servicio</a>
          </div>
        </div>
