...
function Logo() {
  ...
  return (
    <>
      <div className="flex self-center md:grid md:grid-cols-1 gap-0 text-white ">
        ...
        <Link href="/">
          <span className="pl-4 p-0 text-center text-xl lg:text-xl tracking-tight">De Área a Área</span>
        </Link>
      </div>
    </>
  )
