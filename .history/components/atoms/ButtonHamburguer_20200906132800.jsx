  ...
  return (
    <>
      <button onClick={toggleNav}
        className="md:hidden rounded-lg focus:outline-none focus:shadow-outline z-10 flex justify-end" >
        <svg fill-fillRule="currentColor" viewBox="0 0 20 20" className="w-12 h-12">
