        ...
        <main>
          <div class="block md:flex md:space-x-2 px-2 lg:p-0">
            ...
            <a class="w-full md:w-1/3 relative rounded" href="./blog.html">
              <div class="hidden md:absolute left-0 top-0 w-full h-full z-10"></div>
              <img
          ...
          <div class="block lg:flex lg:space-x-2 px-2 lg:p-0 mt-10 mb-10">
            ...
            <div class="w-full lg:w-2/3">
              ...
              <div class="bg-white rounded grid grid-cols-1 md:grid-cols-2 gap-2 place-items-stretch leading-normal">
                <CardsPost />
                <CardsPost />
                <CardsPost />
                <CardsPost />
