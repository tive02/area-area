...
const Post = () => {
  ...
  const changeInlineStyle = (inlineStylesRanges) => {
    switch (inlineStylesRanges.style) {
      case "BOLD":
        for (const style of inlineStylesRanges) {
                    ...
                    <div className="pb-6" key={block.key}>
                      {
                        ...
                        changeInlineStyle(block.inlineStyleRanges))
                      }
                    </div>
                  ))}
                </div>
