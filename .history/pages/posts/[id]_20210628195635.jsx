  ...
  const changeStyles = (text, inlineStyleRanges) => {
    inlineStyleRanges.map((inlineStyle) => {
      switch (inlineStyle.style) {
        case "BOLD":
          let offsetBold = inlineStyle.offset;
          let lengthBold = inlineStyle.length;

          return (
            console.log(offsetBold),
            console.log(lengthBold),
            console.log(text.slice(offsetBold, lengthBold))
          );
          break;
        case "ITALIC":
          ...
          return (
            console.log(offset),
            console.log(length),
            console.log(text.slice(offset, length))
          );
          break;
        default:
          break;
