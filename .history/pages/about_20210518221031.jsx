      ...
      <section className="bg-white">
        <div className="max-w-5xl px-6 py-16 mx-auto text-center">
          ...
          <div className="grid gap-8 mt-6 md:grid-cols-2 lg:grid-cols-3">
            <CardsUser img="https://instagram.fbog2-5.fna.fbcdn.net/v/t51.2885-15/sh0.08/e35/s640x640/89226505_885808458540646_594833344152570836_n.jpg?tp=1&_nc_ht=instagram.fbog2-5.fna.fbcdn.net&_nc_cat=110&_nc_ohc=CA9-e5YFpp4AX-Idx23&edm=ABfd0MgBAAAA&ccb=7-4&oh=568197254d3243fdcbfd99839a924bdf&oe=60C8387E&_nc_sid=7bff83" />
            <CardsUser />
            <CardsUser />
          </div>
        </div>
