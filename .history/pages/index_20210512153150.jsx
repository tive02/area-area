              ...
              <div class="w-full md:w-4/7">
                ...
                <div class="rounded w-full flex flex-col md:flex-row mb-10">
                  ...
                  <div class="bg-white rounded px-4">
                    ...
                    <p class="block md:hidden p-2 pl-0 pt-1 text-sm text-gray-600">
                      ...
                      performed on existence as discourse is. Pleasure friendly
                      at marriage blessing or
                    </p>
                  </div>
                </div>
                ...
                <div class="rounded w-full flex flex-col md:flex-row mb-10">
                  ...
                  <div class="bg-white rounded px-4">
                    ...
                    <div class="md:mt-0 text-gray-800 font-semibold text-xl mb-2">
                      Fond his say old meet cold find come whom. The sir park
                      sake bred.
                    </div>
                    <p class="block md:hidden p-2 pl-0 pt-1 text-sm text-gray-600">
                ...
                <div class="rounded w-full flex flex-col md:flex-row mb-10">
                  ...
                  <div class="bg-white rounded px-4">
                    ...
                    <div class="md:mt-0 text-gray-800 font-semibold text-xl mb-2">
                      Advice me cousin an spring of needed. Tell use paid law
                      ever yet new.
                    </div>
                    <p class="block md:hidden p-2 pl-0 pt-1 text-sm text-gray-600">
